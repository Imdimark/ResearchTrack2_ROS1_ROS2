...
import actionlib
from rt2_assignment1.msg import DoDishesAction
...
def main():
    ...
    server = actionlib.SimpleActionServer('/reaching_goal', PlanningAction,go_to_point self.execute, False)
	server.start()
